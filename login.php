...
.header {
    background:url(http://bloods-industries.co/wp-content/uploads/2016/12/Unsilenced-5.jpg);
...
<div class="row">
  <div class="container">
  	...
  	<div>
        <h2>Login into your ASA ID</h2>
        <p>If you don't have a ASA ID, please <a href="register.php" class="cn">create one here</a>.</p>
        <br>
    </div>
